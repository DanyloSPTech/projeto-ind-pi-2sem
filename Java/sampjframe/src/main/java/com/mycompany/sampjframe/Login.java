...
//        txtSerialGerado.setVisible(false);
    ...
    private void btLogarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btLogarActionPerformed
        ...
        if(email.equalsIgnoreCase(autenticacaoApi.getEmailUsuario()) && serial.equalsIgnoreCase(autenticacaoApi.getSerialMaquina())){
                ...
                List <Componente> listaTermometro = componenteCrud.listarTermometroMaquina(autenticacaoApi.getIdMaquina());
                ...
                for(Componente termometro : listaTermometro){
                    compTemp = termometro;
                }
                ...
                janela2.setTermometro(compTemp);
